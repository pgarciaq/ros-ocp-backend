...
func TestClassifySnapshot_Orphaned(t *testing.T) {
	...
	assert.Contains(t, codes, types.NotifSnapshotOrphaned)
}
...
func TestClassifySnapshot_Managed(t *testing.T) {
	...
	assert.Contains(t, codes, types.NotifSnapshotManaged)
}
...
func TestClassifySnapshot_Stale(t *testing.T) {
	...
	assert.Contains(t, codes, types.NotifSnapshotStale)
}
...
func TestClassifySnapshot_NeverRestored(t *testing.T) {
	...
	assert.Contains(t, codes, types.NotifSnapshotNeverUsed)
}
...
func TestClassifySnapshot_Redundant(t *testing.T) {
	...
	assert.Contains(t, codes, types.NotifSnapshotRedundant)
...
func TestClassifySnapshotInventory_NoPool(t *testing.T) {
	...
	assert.Contains(t, byName["orphaned-snap"].NotificationCodes, types.NotifSnapshotOrphaned)
