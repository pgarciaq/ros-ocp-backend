...
| [0303](https://github.com/pgarciaq/ros-ocp-backend/blob/{{ git_branch }}/docs/adr/0303-library-extraction-librobne.md) | Library extraction (librobne) | Nested in-process engine module; container-first P4; zero convert loops |
