...
| [0336](https://github.com/pgarciaq/ros-ocp-backend/blob/{{ git_branch }}/docs/adr/0336-robne-json-entity-sibling-arrays.md) | robne JSON per-entity sibling arrays | Keep `recommendations` container-only; namespace (and later entities) on sibling keys |
