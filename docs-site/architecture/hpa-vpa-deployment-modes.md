...
| **Local Mode (planned)** | Operator computes on-cluster; optional push to central for fleet view | **Not implemented** — [local-mode.md](../planned-features/local-mode.md) | Advisory; local `ros-ocp-api` is read-only |
...
[Local Mode](../planned-features/local-mode.md) explicitly keeps `ros-ocp-api` **read-only**.
...
- Node consolidation Tier 1 is explicitly
  [advisory only](../planned-features/machineset-recommendations.md#tier-1-advisory-consolidation-with-safety-gates-shipped).
...
- [machineset-recommendations.md — Tier 1–3 actuation tiers](../planned-features/machineset-recommendations.md#tier-overview)
- [autoscaler-optimization.md — Tier 3 MachineAutoscaler](../planned-features/autoscaler-optimization.md)
- [local-mode.md](../planned-features/local-mode.md) — planned on-cluster compute
- [koku-metrics-operator architecture](https://github.com/project-koku/koku-metrics-operator/blob/main/docs/architecture.md)
