...
- **[Integrating librobne](architecture/librobne.md)** — Embed the same engine in-process (`Recommend*` / `Apply*`). Import path is `github.com/redhatinsights/ros-ocp-backend/librobne`; this site is https://pgarciaq.github.io/ros-ocp-backend/ ; HTML API browse https://pgarciaq.github.io/ros-ocp-backend/pkg/ .
