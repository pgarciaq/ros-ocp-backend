...
| [hosted-control-plane-fleet-optimization.md](hosted-control-plane-fleet-optimization.md) | HCP / HyperShift & fleet control-plane FinOps (topology, management CP rightsizing, cross-plane causality, HC lifecycle) |
