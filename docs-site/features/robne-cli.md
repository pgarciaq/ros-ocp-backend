...
| **Business hours** | YAML `business_hours:` dual digest streams ([#479](https://github.com/pgarciaq/ros-ocp-backend/issues/479)). **Shipped** (container + namespace JSON v10). csv/table hard error. Product node API is [#484](https://github.com/pgarciaq/ros-ocp-backend/issues/484). CLI JSON node/GPU/VM BH is [#487](https://github.com/pgarciaq/ros-ocp-backend/issues/487). |
