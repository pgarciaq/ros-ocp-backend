...
|----------|--------|---------|
| [Component Definition](https://github.com/pgarciaq/ros-ocp-backend/blob/pgarciaq-rosocp-superpowers-phase17/docs/fedramp/oscal/component-definition.json) | OSCAL JSON v1.1.3 | 19 control-to-implementation mappings |
| [Plan of Action & Milestones](https://github.com/pgarciaq/ros-ocp-backend/blob/pgarciaq-rosocp-superpowers-phase17/docs/fedramp/oscal/plan-of-action-and-milestones.json) | OSCAL JSON v1.1.3 | 13 open findings with remediation plans |
