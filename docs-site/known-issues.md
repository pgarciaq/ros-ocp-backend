...
| Topic | Issue |
|-------|-------|
| Remaining `rh_accounts` joins on **cluster-scoped** paths (list/history/quality/savings-summary alias join done; directory lookups remain) | [#445](https://github.com/pgarciaq/ros-ocp-backend/issues/445) |
