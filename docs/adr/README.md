...
| [0305](0305-robne-cli-standalone-binary.md) | robne CLI as Standalone Binary Separate from ros-ocp-backend | Deployment / Ops | Phase 1+2a | Accepted |
...
| [0336](0336-robne-json-entity-sibling-arrays.md) | robne JSON envelope uses per-entity sibling arrays (container, namespace, node, GPU, PVC, VM, quota) | CLI / API | 2b | Accepted |
