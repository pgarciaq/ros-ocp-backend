...
| [0336](0336-robne-json-entity-sibling-arrays.md) | robne JSON envelope uses per-entity sibling arrays (container, namespace, node, GPU, PVC, VM) | CLI / API | 2b | Accepted |
