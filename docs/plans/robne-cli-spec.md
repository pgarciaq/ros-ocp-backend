...
Phase 1 (container files → stdout) is **shipped**. Phase **2b** files → stdout is **shipped**. Still open for **(a)(b):** Phase 3 `diff` ([#480](https://github.com/pgarciaq/ros-ocp-backend/issues/480)). Still open for **(c):** 2c.
