...
| **(c)** keep other entity recs | Same persist, other tables | [#473](https://github.com/pgarciaq/ros-ocp-backend/issues/473) **shipped.** Recs only; Path A still skips those plugins until [#482](https://github.com/pgarciaq/ros-ocp-backend/issues/482). |
...
Phase 1 (container files → stdout) is **shipped**. Phase **2b** files → stdout is **shipped**. Phase **2c** other-entity rec upsert is **shipped**. Still open for **(a)(b):** Phase 3 `diff` ([#480](https://github.com/pgarciaq/ros-ocp-backend/issues/480)). Still open for **(c):** other-entity digests ([#481](https://github.com/pgarciaq/ros-ocp-backend/issues/481) / [#482](https://github.com/pgarciaq/ros-ocp-backend/issues/482)).
