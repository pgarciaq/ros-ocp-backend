...
| **Phase 2b — other entity CSVs** ([#472](https://github.com/pgarciaq/ros-ocp-backend/issues/472)) | same | **(a)(b)** for node/namespace/GPU/PVC/…. Stdout. Independent of 2a. **Namespace + node/GPU + PVC + VM + quota + cluster_quota stdout shipped** (JSON v2–v8 sibling arrays). Remaining 2b under #472 is none. **Do not close.** |
...
| **(a)(b)** other entities | More CSVs → stdout | [#472](https://github.com/pgarciaq/ros-ocp-backend/issues/472) — namespace + node/GPU + PVC + VM + quota + cluster_quota stdout shipped. **Can run without 2a.** |
...
Phase 1 (container files → stdout) is **shipped**. Phase **2b** files → stdout is **shipped**. Still open for **(a)(b):** Phase 3 `diff`. Still open for **(c):** 2c.
...
| **2b** | [#472](https://github.com/pgarciaq/ros-ocp-backend/issues/472) | **(a)(b)** other entity CSVs → stdout. **Namespace + node/GPU + PVC + VM + quota + cluster_quota stdout shipped.** Remaining 2b under #472 is none. **Do not close.** |
...
| **2b** ([#472](https://github.com/pgarciaq/ros-ocp-backend/issues/472)) | Other entity CSVs | JSON / CSV / table envelopes. **Namespace + node/GPU + PVC + VM + quota + cluster_quota stdout shipped.** Remaining 2b under #472 is none. |
...
No code beyond the current child until that issue is the active sprint. Remaining **2b** under [#472](https://github.com/pgarciaq/ros-ocp-backend/issues/472) is none. **Next:** **2c / [#473](https://github.com/pgarciaq/ros-ocp-backend/issues/473)** (other entity PG). **Do not close #472** after the cluster_quota slice.
