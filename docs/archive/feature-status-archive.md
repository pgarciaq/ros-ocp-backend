> **Historical archive** — frozen feature-status / known-issues megadoc (as of 2026-08-07).
> Current limitations: [Known Limitations](../known-issues.md). Open work: GitHub issues linked from that page.
