> **Historical — Superseded 2026-08-15.** This was the Cut-1 (pure-function +
> adapter) extraction plan. It is **rejected**. The live plan is
> [`docs/plans/librobne-extraction-blueprint.md`](../plans/librobne-extraction-blueprint.md).
> Kept so the discarded design is auditable.

# librobne extraction blueprint (Cut 1, superseded)

**Status:** Superseded (was Draft for review 2026-08-12)  
...
- Is **statically linked** into consumers (ros-ocp-backend, future robne-operator Local Mode, robne CLI)
