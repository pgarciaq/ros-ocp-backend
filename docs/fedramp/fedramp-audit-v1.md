...
| AU-02 | No log integrity/immutability controls at service layer | AU-9 | **High** | Document as inherited from CloudWatch (encryption, access controls) |
...
| AU-05 | No centralized SIEM integration documented | AU-6 | **Medium** | Document platform-level SIEM (Splunk/ELK) in SSP as inherited |
