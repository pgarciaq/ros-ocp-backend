...
[known-issues.md § GPU MIG — Known limitations (Gap 5)](../archive/feature-status-archive.md#gpu-mig-known-limitations-gap-5).
Full tracking table:
[known-issues.md § GPU: Deferred / Future Work](../archive/feature-status-archive.md#gpu-deferred-future-work).
