...
See [Local Development](../../docs-site/development.md#adding-a-plugin).
...
5. **Blank-import** `_ ".../internal/plugins/vm"` from [`internal/plugins/plugins.go`](../../internal/plugins/plugins.go) (not `registry.go`).
