-- Add category column to node_recommendations, backfill from existing
-- boolean/enum fields, then drop the replaced booleans.
--
-- node_recommendation_history is intentionally omitted: node CPU/memory
-- recommendations have no history table, persist path, or API (#464).
