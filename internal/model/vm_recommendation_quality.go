...
// VMQualityRow maps to a row from vm_recommendation_quality joined with clusters.
type VMQualityRow struct {
	...
	SaturationDays       *int64    `gorm:"column:saturation_days" json:"saturation_days"`
