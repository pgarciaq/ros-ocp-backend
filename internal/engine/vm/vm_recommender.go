...
func RecommendVM(
	...
	if isAbandoned {
		...
		cpuMarginBP = int32(cpuMargin * float64(rootengine.BasisPointsScale))
		memMarginBP = int32(cfg.MemMarginMin * float64(rootengine.BasisPointsScale))
...
func vmExplFromRecommendation(r model.VMRecommendation) rootengine.VMExplanationFactors {
	...
	return rootengine.VMExplanationFactors{
		DataDays:               dataDays,
