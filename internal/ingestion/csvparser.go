...
// non-numeric inputs. Namespace, PVC, VM, snapshot, and cluster-quota parsers
// still use this helper; container ROS parse lives in librobne/csv.
...
// non-numeric inputs. Other-entity ingest parsers still use this helper.
