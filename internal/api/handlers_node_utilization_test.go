...
func TestGroupNodeUtilizationRows_NestsTermsAndEngines(t *testing.T) {
	...
	out := groupNodeUtilizationRows(rows, "", "", false, money.DefaultCurrency)
	require.Len(t, out, 1)
...
func TestGroupNodeUtilizationRows_TermFilterSelectsPrimary(t *testing.T) {
	...
	out := groupNodeUtilizationRows(rows, "", "short", false, money.DefaultCurrency)
	require.Len(t, out, 1)
...
func TestGroupNodeUtilizationRows_EngineFilter(t *testing.T) {
	...
	out := groupNodeUtilizationRows(rows, "cost", "", false, money.DefaultCurrency)
	require.Len(t, out, 1)
